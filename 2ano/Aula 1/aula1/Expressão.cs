...
public class Soma : Expressao
{
    ...
    public override Expressao Derivar (Simbolo x) => new Soma(a.Derivar(x), b.Derivar(x));
}
...
public class Subtracao : Expressao
{
    ...
    public override Expressao  Derivar(Simbolo x) => new Subtracao(a.Derivar(x), b.Derivar(x));
