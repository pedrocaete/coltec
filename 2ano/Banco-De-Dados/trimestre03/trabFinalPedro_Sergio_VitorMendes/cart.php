                        ...
                        <tbody>
                            ...
                            if (!empty($cart)) {
                                foreach ($cart as $productId => $quantity) {
                                    $product = $allProducts[$productId-1];
                                    ...
                                    echo '<tr>
                                            ...
                                            <td>
                                                <p class="mb-0 mt-4">' . $product['nome'] . '</p>
                                            </td>
                                            <td>
                                                <p class="mb-0 mt-4">' . $product['preco'] . ' $</p>
                                            </td>
                                            <td>
                                            ...
                                            <td>
                                                <p class="mb-0 mt-4">' . $productTotal . ' $</p>
                                            </td>
                                            <td>
